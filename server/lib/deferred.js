...
*/
/*
	Copied from: https://github.com/felixge/node-deferred/blob/master/lib/deferred.js
	Latest commit when copied: https://github.com/felixge/node-deferred/commit/5c6198c480475844db82a5c17cd63c94cc369a7b
	21 Aug 2011	
 */
...
deferred.Deferred = function(/*Function?*/ canceller){
  ...
  // Do not catch exceptions by default (this is different from dojo.Deferred)
...
deferred.Deferred.prototype =  {
  ...
  // Custom extension to control trycatch behavior, not part of dojo.Deferred
  trycatch: function(trycatch) {
    this.autoCatch = !trycatch;
    return this;
  },
